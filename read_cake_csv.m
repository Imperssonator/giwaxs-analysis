function cake_struct = read_cake_csv(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as column vectors.
%   [ROWINT,E,NSITYSU,M,OVERRANGEQ028205341] = IMPORTFILE1(FILENAME) Reads
%   data from text file FILENAME for the default selection.
%
%   [ROWINT,E,NSITYSU,M,OVERRANGEQ028205341] = IMPORTFILE1(FILENAME,
%   STARTROW, ENDROW) Reads data from rows STARTROW through ENDROW of text
%   file FILENAME.
%
% Example:
%   [Rowint,e,nsitysu,m,overrangeQ028205341] = importfile1('NP_2day_sonicated_parallel_12111644_0001.tif cake_rows.csv',3, 452);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/03/17 15:54:12
...
cake_struct=struct('Chi',Chi-90,'I',Intensity);
